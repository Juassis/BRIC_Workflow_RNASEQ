...
y=c(1,1,1,1,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
z=c(3,7,8,13,18,20,23,23,26,29,29,29,31,32,35,36,39,40,41,42)
w=c(2,6,7,12,16,18,21,21,24,27,27,27,29,30,33,34,37,38,39,40)
m=max(0,0,0)
n=min(0,0,0)
