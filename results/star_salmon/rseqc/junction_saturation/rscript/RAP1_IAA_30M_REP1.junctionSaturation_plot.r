...
y=c(2,2,2,2,2,2,2,2,2,2,2,2,2,3,3,3,3,3,3,3)
z=c(8,17,22,26,30,32,37,39,41,44,48,48,50,53,56,58,59,61,62,63)
w=c(6,15,20,24,28,30,35,37,39,42,46,46,48,50,53,55,56,58,59,60)
m=max(0,0,0)
n=min(0,0,0)
